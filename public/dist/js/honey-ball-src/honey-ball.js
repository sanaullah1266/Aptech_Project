class HoneyBallClass {
  ...
  pulse(clockWise) {
    ...
    this.animTween = gsap.to(this, {
      ...
      onUpdate: () => {
        ...
        this.uniforms.u_freq1.value =
          0.55 + this.pulseFactor * this.animationParamFactors.frequency;
        this.uniforms.u_amp1.value =
          3.0 + this.pulseFactor * this.animationParamFactors.amplitude; // was 2.09
        this.uniforms.u_lightfac.value =
          1 + this.pulseFactor * this.animationParamFactors.light;
      },
    });
  ...
  setParams(params) {
    ...
    if (params.reflectionColor)
      this.uniforms.u_refColor.value = new this.THREE.Color(
  ...
  update(intersects, dt) {
    ...
    this.ballMesh.material.uniforms.u_bubblesDepth.value =
      BubblesFBO.FBO.depthTexture;
  }

  windowResize(THREE) {
    this.ballMesh.material.uniforms.u_res.value = new THREE.Vector2(
      window.innerWidth,
      window.innerHeight
    );
  }
