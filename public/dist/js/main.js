const imagesUrls = [
    "../img/assets/ssi-mood.webp",
    "../img/assets/op-mood.webp",
    "../img/assets/va-mood.webp",
    "../img/assets/hy-mood.webp",
    "../img/assets/oa-mood.webp",
    "../img/assets/be-mood.webp",
    "../img/assets/hp-mood.webp",
    "../img/assets/ho-mood.webp",
    "../img/assets/md-mood.webp",
    "../img/assets/default-mood.webp",
  ],
...
let thisClass,
  ...
  ballY = 0,
  ballSpeed = 0.17,
  heroAnim = gsap.timeline({ paused: !0 });
...
let shapeStart,
  ...
  menuMid,
  menuEnd,
  pageMaster = gsap.timeline({ paused: !0 }),
  hambIcon = gsap.timeline({ paused: !0 }),
  menuBgAnim = gsap.timeline({ paused: !0 }),
  ...
  if (isMobile()) {
    ...
    (shapeStart =
      ...
      pageShape.forEach((e) => {
        ...
        gsap.set(t, { morphSVG: shapeStart });
      });
  }
} else
  (shapeStart =
    ...
    (menuMid =
      "M0 330.791C0 314.732 18.1732 304.806 32.0206 312.937C78.3273 340.127 166.163 385.5 236.667 385.5C337.333 385.5 392.495 0.5 473.333 0.5C556.906 0.5 626.428 331 710 331C800.016 331 856.651 122 946.667 122C1067.34 122 1062.66 486.5 1183.33 486.5C1257.01 486.5 1328.93 297.715 1373.79 150.656C1380.74 127.87 1420 133.102 1420 156.924V840C1420 851.046 1411.05 860 1400 860H20C8.95432 860 0 851.046 0 840V330.791Z"),
    (menuEnd =
...
if (isMobile()) {
  function pageOut() {
    let e = gsap.timeline();
    return (
      e.to("#pageBgAnim", { morphSVG: page2, duration: 0.8, ease: "expo.in" }),
      e.to(
        ".page-to-page svg:nth-of-type(2)",
        { duration: 0.8, ease: "expo.in" },
        "<"
      ),
      e.to("#pageBgAnim", { morphSVG: page3, duration: 0.8, ease: "expo.out" }),
      e.to(
        ".page-to-page svg:nth-of-type(2)",
  ...
  function pageIn() {
    ...
    return (
      ...
      e.to(
        ...
        { yPercent: 100, duration: 0.8, ease: "expo.in" },
        "<"
      ),
      e.to("#pageBgAnim2", {
        morphSVG: shapeStart,
...
const menuOpen = function () {
  ...
  (lineB = "M21 30H9"),
    ...
    hambIcon.to(
      ".lineB",
      { morphSVG: lineB, duration: 1, ease: "power4.inOut" },
      "<"
    ),
    hambIcon.to(
      ".lineC",
      { morphSVG: lineC, duration: 1, ease: "power4.inOut" },
      "<"
    ),
    hambIcon.to(
      ".pointA",
  ...
  (menuInner = gsap.timeline({
    onStart: function () {
      wrapper.classList.add("is-exiting"),
        gsap.to(glContainer, { opacity: 0, duration: 0.3, ease: "power4" }),
    ...
    onReverseComplete: function () {
      wrapper.classList.remove("is-exiting"),
        gsap.to(glContainer, { opacity: 1, duration: 0.3, ease: "power4" }),
        gsap.to(".page-to-page svg:first-of-type", {
          opacity: 1,
          duration: 0.3,
        }),
    ...
    menuInner.to(menuWrap, { y: "0%", duration: 0.35, ease: "power4" }),
...
function triggerDotAnim() {
  ...
  e.forEach((e) => {
    ...
    gsap.set(e, { x: t - a - i / 2, y: o - s - n / 2, opacity: 1, scale: 0 });
  });
  ...
  i.to(["#logo", "#hamburger"], {
    ...
    i.to(".ec.main", { scale: 1, duration: 1.5, ease: customEaseC }, "<"),
    i.to(
      "#pageBgAnim",
      {
        morphSVG: { shape: easterPath, type: "rotational" },
        duration: 1.5,
        ease: customEaseC,
      },
      "<"
    ...
    i.to(
      "#blurDeviation",
      { duration: 1.5, attr: { stdDeviation: 17 }, ease: customEaseC },
      "<"
    ),
    i.to(
      e,
  ...
  (g.volume = 0),
    ...
    l.addEventListener("click", function () {
      ...
      for (let e = 0; e < 100; e++)
        setTimeout(() => {
          (g.volume = 1 - 0.01 * e), 99 == e && g.pause();
        }, 10 * e);
      i.reverse().timeScale(-2),
        gsap.delayedCall(0.5, p),
...
if (
  ...
  document.querySelector(".about") && !isMobile())
)
  triggerDotAnim();
else {
  let t = new SplitText(".about #hero h1", { type: "lines, chars" });
  gsap.set(".about #hero h1", { perspective: 400 }),
    gsap.set(t.chars, {
      transformOrigin: "0% 100%",
      scale: 6,
...
PageInits = {
  ...
  mainScripts: function () {
    if (
      ...
      const i = -s + (window.innerWidth - 4 * o),
        n = function () {
          ...
          gsap.to(t, { scale: 1 - i / 2 }), (a = e), requestAnimationFrame(n);
        };
      n(),
        gsap.to(t, {
          scrollTrigger: {
    ...
    if (document.querySelector("#attitude") && isAndroid()) {
      ...
      i.to(t, { yPercent: (e, t) => 20 * e + 15, stagger: 1, duration: 1 }),
        i.to(o, { backgroundColor: "#171A37", duration: 1, stagger: 1 }, "<"),
        i.to(a, { yPercent: 60, duration: 1 }, "-=2");
    }
    if (document.querySelector(".client-wrap") && !isMobile()) {
      ...
      r.to(e, { x: -i, ease: "linear" }),
        r.to(t, { x: n, ease: "linear" }, "<");
      const c = document.querySelector(".client-stat"),
        ...
        g = gsap.timeline({ repeat: -1 });
      g.to(u, { duration: 0.3, scale: 1.3, delay: 0.5, ease: "power3.in" }),
        g.to(u, { duration: 0.3, scale: 1, ease: "power3.out" }),
        a.forEach((e) => {
          e.addEventListener("mouseenter", function () {
    ...
    const e = gsap.utils.toArray(".title-switch span:not(.first)"),
      t = new SplitText(e, { type: "chars" }),
      o = document.querySelector(".button-switch img");
    let a = 0,
      s = -0;
    if (
      (gsap.set(t.chars, { yPercent: 102 }),
          ...
          e.to(i, {
            ...
            e.to(
              n,
              {
                ...
                ease: "elastic",
                onComplete: function () {
                  gsap.set(i, { yPercent: 110 });
                },
              },
              "<"
            ),
            e.to(o, { rotate: s, ease: "back" }, "<");
        };
      isMobile() ||
        (e.addEventListener("mouseenter", function () {
          i.isActive() || n();
    ...
    if (document.querySelector(".button")) {
      gsap.utils.toArray(".button").forEach((e) => {
        ...
        e.querySelector("i");
        e.addEventListener("mouseenter", function () {
          gsap.timeline().to(t, { scale: 1.1, duration: 1, ease: "elastic" });
        }),
          e.addEventListener("mouseleave", function () {
            gsap.timeline().to(t, { scale: 1, duration: 1, ease: "elastic" });
          });
      });
    }
    if (document.querySelector(".usp-carousel")) {
      ...
      gsap
        ...
        .from(e, {
          y: "100%",
          duration: o,
          stagger: { each: s, repeat: -1, repeatDelay: i },
        })
        .to(
          e,
          {
    ...
    if (document.querySelector("#fixed-cta")) {
      ...
      (function () {
        ...
        e.addEventListener("mouseenter", function () {
          ...
          e.addEventListener("click", function () {
            gsap.to(glContainer, { opacity: 0, duration: 0.5, ease: "power4" });
          }),
          e.addEventListener("click", function () {
        ...
        (scrollFixCta = function () {
          (ctaFixIn = gsap.timeline({
            ...
            ctaFixIn.to(e, { scale: 0, duration: 0.4, ease: "expo.inOut" });
        }),
        scrollFixCta();
    }
    if (
      ...
      gsap.utils.toArray(".section-title").forEach((e) => {
        ...
        gsap.set([t, o], { scale: 0 }), gsap.set(e, { x: "2em", opacity: 0 });
    ...
    if (document.querySelector(".side-scroll") && !isMobile()) {
      ...
      const s = function () {
        ...
        gsap.to(o, { scale: 1 - r / 2 }), (a = e), requestAnimationFrame(s);
      };
      s();
      const i = function () {
    ...
    if (
      (Promise.all([i.load(), n.load()]).then(function () {
        ...
        let i = new SplitText(".hero-split.chars", { type: "lines, chars" });
        ...
        gsap.utils.toArray(".line-anim").forEach((e) => {
          ...
          i.from([o, t], {
            ...
            i.from(o, { x: -s, duration: 1, ease: customEaseB }, "-=.5"),
            i.from(a, { scaleX: 0, duration: 1, ease: customEaseB }, "-=1");
        });
      }),
      ...
      Draggable.create(".draggable .slider-inner", {
        ...
        e.addEventListener("mouseenter", function () {
          c.classList.add("moving"),
            gsap.to(l, { scale: 1, duration: 0.4, ease: "power4" }),
            bodyTag.style.setProperty("cursor", "none");
        }),
        e.addEventListener("mousedown", function () {
          e.classList.add("down"),
            c.classList.add("is-on"),
            gsap.to(l, { scale: 0.8, duration: 0.4, ease: "power4" });
        }),
        ...
        e.addEventListener("mouseleave", function () {
          c.classList.remove("is-on"),
            ...
            gsap.to(l, { scale: 0, delay: 0.1, duration: 0.3, ease: "power4" }),
    ...
    if (document.querySelector(".timeline") && !isMobile()) {
      ...
      p.to(e, { y: i, x: "-20%", scale: 0.8, duration: 0.2, ease: "linear" }),
        p.to(e, { x: -g, duration: 2, ease: "linear" }),
        p.to(a, { x: -g, duration: 2, ease: "linear" }, "-=2.12"),
        p.to(t, { x: 0, duration: 0.3, ease: "linear" }, "-=.5"),
        p.to(t, { y: 0, scale: 1, duration: 0.1, ease: "linear" }, "-=.3"),
        p.to(
          o,
      ...
      i.to(e, { opacity: 0, scale: 0.5, duration: 0.5, ease: "linear" }),
        i.to(
          t,
          {
        ...
        i.to(o, { y: 0, scale: 1, duration: 1, ease: "linear" }, "-=.5"),
        i.to(s, { opacity: 0, duration: 0.4 }, "<");
    }
      ...
      gsap.set(a, { opacity: 0, pointerEvents: "none" }),
        ...
        e.forEach((e) => {
          e.addEventListener("click", function () {
            ...
            if (!e.classList.contains("step-first")) {
              ...
              setTimeout(function () {
                (o.parentNode === t ? r : t).appendChild(o),
            ...
            gsap.to(t, { scaleX: 0.2 * n, duration: 0.4, ease: "power4" }),
              document
        ...
        a.addEventListener("click", function () {
          ...
          if (
            ...
            setTimeout(function () {
              (c.parentNode === l ? s : l).appendChild(c),
          ...
          document
            ...
            gsap.to(t, { scaleX: 0.2 * i, duration: 0.4, ease: "power4" });
        });
    }
    if (document.querySelector(".work-listing")) {
      document
        ...
        .forEach((e) => {
          ...
          c.to(i, { morphSVG: r, duration: 0.7, ease: "power4.in" }),
            c.to(
              s,
              {
                opacity: 1,
          ...
          if (
            ...
            let e = new SplitText(l, { type: "chars" });
            ...
            t.to(e.chars, {
              ...
              t.to(o, { y: -10, duration: 0.3, ease: "power4.inOut" }, "<"),
              a.addEventListener("mouseenter", function () {
    ...
    if (document.querySelector("#awards") && !isMobile()) {
      ...
      ScrollTrigger.create({
        ...
        s.to(a, { y: "0%", duration: 2, ease: "linear" }, "-=2");
    }
    if (document.querySelector(".work")) {
        ...
        l = function () {
          o.forEach((e) => {
            ...
            e.addEventListener("mouseenter", function () {
              ...
              MainThreeScene.changeTexture(a, !1),
                gsap.to(t, { scale: 1, duration: 0.4, ease: "power4" }),
                gsap.to(o, {
                  opacity: 1,
                  y: "135%",
                  duration: 0.4,
              ...
              e.addEventListener("mouseleave", function () {
                e.classList.remove("hovered"),
                  gsap.to(t, { scale: 0.8, duration: 0.4, ease: "power4" }),
                  gsap.to(o, {
                    opacity: 0,
                    y: "160%",
                    duration: 0.4,
      ...
      const g = gsap.timeline({ paused: !0 }),
        p = gsap.timeline({ paused: !0 });
      isMobile()
        ? (g.to(glContainer, { y: "-13%", duration: 1, ease: customEaseC }),
          g.to(
            ".open-thumbs",
            { opacity: 0, duration: 1, ease: customEaseC },
            "<"
          ),
          g.to(
            ".close-thumbs",
            { opacity: 1, duration: 1, ease: customEaseC },
            "<"
          ),
          g.to(i, { height: "3em", duration: 1, ease: customEaseC }, "<"),
          g.to(
            ".layout-b article",
            {
              x: 0,
          ...
          p.to(glContainer, { y: "0%", duration: 1, ease: customEaseC }),
          p.to(
            ".open-thumbs",
            { opacity: 1, y: 0, duration: 1, ease: customEaseC },
            "<"
          ),
          p.to(
            ".close-thumbs",
          ...
          p.to(i, { height: "2em", duration: 1, ease: customEaseC }, "<"),
          p.to(
            ".layout-b article",
            {
              x: (e, t) =>
          ...
          p.to(
            s,
            { opacity: 0, rotateZ: 90, duration: 0.5, ease: customEaseC },
            "<"
          ),
          p.to(
            n,
        ...
        : (g.fromTo(
            glContainer,
            { y: "0%", duration: 1, ease: customEaseC },
            { y: "-13%", duration: 1, ease: customEaseC }
          ),
          g.to(
            ".open-thumbs",
            { opacity: 0, y: "-1em", duration: 1, ease: customEaseC },
            "<"
          ),
          g.to(
            ".close-thumbs",
          ...
          g.to(i, { height: "2.5em", duration: 1, ease: customEaseC }, "<"),
          g.to(
            ".layout-b article",
            {
              x: 0,
          ...
          p.to(i, { height: "1.5em", duration: 1, ease: customEaseC }, "<"),
          p.to(
            ".layout-b article",
            {
              x: (e, t) =>
      ...
      const I = function () {
        ...
        Z = function () {
          ...
          (h -= 1),
            ...
            w > f && (w = 1),
            S < 1 && (S = 9),
            MainThreeScene.changeTexture(h, !0);
          P.forEach((e) => {
            ...
            e.classList.contains("selected") &&
              ...
              V.to(e, { scale: 1.5, opacity: 0, duration: 1, ease: "power4" }),
              V.to(e, { scale: 1, duration: 0.001, ease: "linear" })),
              t == h &&
            ...
            O.to("#work-titles h2", { y: "100%", duration: 1, ease: "power4" }),
            O.to(
            ...
            O.to(
              "#slide-count li",
              {
                ...
                ease: "power4",
                onComplete: function () {
                  O.to("#slide-count li", { y: "0%", duration: 0.001 }),
                    O.to("#work-titles h2", {
                      y: "0%",
                      rotateZ: 0,
                      duration: 0.001,
        ...
        D = function () {
          ...
          (h += 1),
            ...
            w > f && (w = 1),
            S < 1 && (S = 9),
            MainThreeScene.changeTexture(h, !1);
          P.forEach((e) => {
            let t = e.dataset.page;
            e.classList.contains("selected") &&
              (e.classList.remove("selected"),
    ...
    if (document.querySelector(".work-detail")) {
      ...
      if (
        ...
        !(function e() {
          (ballX += (mouseX - ballX) * ballSpeed),
            (ballY += (mouseY - ballY) * ballSpeed),
            gsap.to(t, { y: ballY, x: ballX, ease: "none", duration: 0.15 }),
            requestAnimationFrame(e);
        })(),
          e.forEach((e) => {
                  ...
                  !o
                    ? e.classList.contains("selected") &&
                      ...
                      ? (e.classList.remove("selected"),
                        ...
                        gsap.to(o, { x: "0", duration: 1, ease: customEaseC }))
                      : e.classList.contains("selected") ||
                        e.classList.contains("disabled") ||
                        !i
                      ? e.classList.contains("selected") &&
                        ...
                        gsap.to(i, { x: "0", duration: 1, ease: customEaseC }))
      ...
      i.addEventListener("mouseenter", function () {
        gsap.timeline().to(n, { scale: 1.1, duration: 1, ease: "elastic" });
      }),
        i.addEventListener("mouseleave", function () {
          gsap.timeline().to(n, { scale: 1, duration: 1, ease: "elastic" });
        });
        ...
        !(function (e) {
          ...
          c.clear(),
            ...
            document.querySelectorAll(".pg-left [data-list]").forEach((e) => {
              ...
              e.classList.contains("selected") &&
                (e.classList.remove("selected"),
                c.to(e, { zIndex: 1, duration: 0.001, ease: "none" }),
                c.to(e, {
                  scale: 1.5,
                  y: "75%",
                  rotateZ: 15,
                ...
                t == o &&
                  ...
                  l.to(e, { y: 0, scale: 1, duration: 1, ease: customEaseC }));
            });
        })(),
          (function (e) {
            if (u.isActive()) return;
            ...
            u.clear(),
              ...
              document
                ...
                .forEach((e) => {
                  ...
                  e.classList.contains("selected") &&
                    (e.classList.remove("selected"),
                    u.to(e, { zIndex: 1, duration: 0.001, ease: "none" }),
                    u.to(e, {
                      scale: 1.5,
                      y: "75%",
                      rotateZ: 15,
    ...
    if (document.querySelector("#intake-form")) {
      ...
      o.addEventListener("click", function (a) {
        if ((a.preventDefault(), t.checkValidity())) {
          ...
          fetch("submission.php", { method: "POST", body: s })
            .then((e) => e.text())
            .then((a) => {
              console.log(a),
                (o.style.backgroundColor = "#D62E49"),
...
changeTheme();
const glIn = function () {
    bodyTag.classList.contains("init") &&
      !isMobile() &&
      ...
      bodyTag.classList.contains("init") ||
        bodyTag.classList.contains("root") ||
...
isMobile()
  ? glScroll.to("#webglBubble", { y: "0", duration: 0.35, ease: "linear" })
...
const updateGl = function () {
  ...
  bodyTag.classList.contains("root")
    ? (MainThreeScene.pause(), gl.disable())
    : (gsap.to(glContainer, {
        zIndex: 2,
        opacity: 1,
        scale: 0.7,
...
const changeTexture = function () {
  bodyTag.classList.contains("default") &&
    ...
    bodyTag.classList.contains("ssi") &&
      ...
      MainThreeScene.setParams({ mainBall: { reflectionColor: 16777215 } })),
    bodyTag.classList.contains("op") &&
      (MainThreeScene.changeTexture(1),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 6841187 } })),
    bodyTag.classList.contains("va") &&
      (MainThreeScene.changeTexture(2),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 15592674 } })),
    bodyTag.classList.contains("hy") &&
      (MainThreeScene.changeTexture(3),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 15592674 } })),
    bodyTag.classList.contains("oa") &&
      (MainThreeScene.changeTexture(4),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 15462387 } })),
    bodyTag.classList.contains("be") &&
      (MainThreeScene.changeTexture(5),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 6254957 } })),
    bodyTag.classList.contains("hp") &&
      (MainThreeScene.changeTexture(6),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 15658473 } })),
    bodyTag.classList.contains("ho") &&
      (MainThreeScene.changeTexture(7),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 15463134 } })),
    bodyTag.classList.contains("md") &&
      (MainThreeScene.changeTexture(8),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 15660799 } })),
    bodyTag.classList.contains("init") &&
      (MainThreeScene.changeTexture(9, !1),
      MainThreeScene.setParams({ mainBall: { reflectionColor: 3554679 } }));
};
changeTexture();
const startScripts = function () {
  PageInits.lazyLoad(), PageInits.mainScripts();
};
let introAnim = gsap.timeline({ paused: !0 });
  ...
  document.body.addEventListener("click", function (e) {
    if (e.target && "nl-submit" === e.target.id) {
      ...
      var o = t.value,
        a = new FormData();
      a.append("mail", o),
        fetch("submission.php", { method: "POST", body: a })
          .then((e) => e.text())
          .then((o) => {
...
introAnim.set(introPaths, { drawSVG: "0% 0%" }),
  ...
  introAnim.to(introBg, { opacity: 1, duration: 0.6, ease: "power4" }),
  introAnim.to(
    introSVG,
    { opacity: 1, scale: 1, duration: 1, ease: "power4" },
    "-=.2"
  ),
  introAnim.to(
    introSpan,
  ...
  introAnim.to(
    introSVG,
    { opacity: 0, scale: 0.9, duration: 0.6, ease: "power4" },
    "-=.5"
  ),
  introAnim.to(
    introSpan,
    { opacity: 0, y: "-100%", duration: 0.6, ease: "power4" },
    "<"
  ),
  ...
  introAnim.to(["#logo", "#usp", "#hamburger", "#fixed-cta"], {
    opacity: 1,
    delay: 0.6,
    duration: 0.6,
    stagger: 0.1,
  ...
  bodyTag.classList.contains("init") ? introLoading() : startScripts(),
  newsletter(),
    ...
    var e = {
        ...
        onStart: {
          ...
          render: function (e) {
            if (
              ...
              document.querySelector(".home") && !isMobile())
            ) {
        ...
        onAfter: function (e, t) {
          ...
          if (document.querySelector(".about") && !isMobile()) triggerDotAnim();
            ...
            let e = new SplitText(".about #hero h1", { type: "lines, chars" });
            gsap.set(".about #hero h1", { perspective: 400 }),
              gsap.set(e.chars, {
                transformOrigin: "0% 100%",
                scale: 6,
