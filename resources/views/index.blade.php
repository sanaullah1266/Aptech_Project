...
<html lang="en" class="no-js">
  <head>
    ...
    <meta
      property="og:title"
      content="Buzzworthy Studio — Creative websites that convert"
    />
    <meta property="og:description" content="" />
    <meta
      property="og:image"
      content="https://buzzworthystudio.com/img/social.jpg"
    />
  ...
  <body class="loading init">
    ...
    <div id="loading-overlay">
      <div>
        ...
        >
          <g
            transform="translate(-1529.000000, -989.000000)"
            fill="none"
            stroke-width="1"
            stroke="#EEEEF2"
          >
    ...
    <a
      ...
      id="logo"
      class="nav-link"
      aria-label="Get back to the home page"
    >
    ...
    <div id="menu-slide">
      <div>
        ...
        <div class="social bs-12">
          <a
            href="https://www.linkedin.com/company/buzzworthystudio/"
            target="_blank"
            class="text-link"
            aria-label="Linkedin"
            >Linkedin</a
          >
          <a
            href="https://www.instagram.com/buzzworthy.studio/"
            target="_blank"
            class="text-link"
          ...
          >
          <a
            href="https://twitter.com/getbuzzworthy"
            target="_blank"
            class="text-link"
            aria-label="Twitter"
            >Twitter</a
          >
          <a
            href="https://www.behance.net/BuzzworthyStudio"
            target="_blank"
            class="text-link"
            aria-label="Behance"
            >Behance</a
          >
          <a
            href="https://dribbble.com/Buzzworthy/"
            target="_blank"
            class="text-link"
            aria-label="Dribbble"
            >Dribbble</a
    ...
    <main id="smooth-wrapper">
      ...
      <div class="scrollPattern">
        <div class="patternTop">
          <img
            class="lazy"
            src="img/pattern-top-prel.png"
            data-src="img/pattern-top.webp"
            data-src-big="img/pattern-top.webp"
        ...
        <div class="patternBottom">
          <img
            class="lazy"
            src="img/pattern-bottom-prel.png"
            data-src="img/pattern-bottom.webp"
            data-src-big="img/pattern-bottom.webp"
            alt="Hexagon line pattern png image"
          />
        </div>
      </div>
      ...
      <div id="drag-ico">
        ...
        <svg viewBox="0 0 54 13" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M25.3519 10L23 6L25.3519 2L29.6485 2L32 6L29.6485 10L25.3519 10Z"
            stroke="#EEEEF2"
            stroke-width="1.5"
            vector-effect="non-scaling-stroke"
          />
          <path
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M7 12L1 6.5L7 0.999996L7 12Z"
            stroke="#EEEEF2"
            stroke-width="1.5"
      ...
      <div class="content home" data-work="init">
        ...
        <div
          id="usp"
          class="bs-xl-os-12 bs-tech bs-sm-os-6 bs-xs-os-3 bs-xs-16 bs-xs-os-4"
        >
          <span>We</span>
          <span>
        ...
        <section id="hero" class="grid-inner">
          ...
          <div>
            <h1 class="bs-220">
              <div>
                <span class="hero-split chars xs-center">Creative</span>
                <span class="hero-split chars red xs-center">Web</span>
              </div>
              <div>
                <span class="hero-split chars red">Web</span>
                <span class="hero-split chars right xs-left">Studio</span>
              </div>
            </h1>
            <div
              id="hero-work-link"
              class="bs-xl-8 bs-xl-os-10 bs-xs-16 bs-xs-os-0 hero-in"
            >
              <a href="opositive.html">
                ...
                <span class="bs-hero-small upper">O Positive</span>
              </a>
            </div>
            <div class="scroll-to hero-in" data-scroll="intro">
              <div class="bs-tech faded">
                (&nbsp;&nbsp;&nbsp;SCROLL&nbsp;&nbsp;&nbsp;)
              </div>
            </div>
        ...
        <section
          id="intro"
          class="hero-intro grid-inner xl-top-2 xs-top-2 bs-grid xs-wrap"
        >
          <div class="bs-xl-2 bs-xs-7">
            <h2 class="section-title">
              <i class="circle-tag"></i><i class="circle-tag"></i>About
            </h2>
          </div>
          <div class="bs-xl-4 bs-xs-16 bs-xl-os-1 bs-xs-os-0 xs-top-1">
            <p class="split lines xl-bottom-3 xs-bottom-2 upper">
              With a decade of experience under our belts, Buzzworthy has become
              a world - renowned studio
            </p>
          </div>
          <div
            class="bs-xl-os-1 bs-xl-10 bs-sm-os-6 bs-sm-12 bs-xs-os-0 bs-xs-22 bs-xs-os-0"
          >
            <p class="bs-60 split lines xl-bottom-4 xs-bottom-2 upper">
              delivering innovative design and development with impactful
              digital marketing campaigns that catapult brands forward.
            </p>
            <a href="studio" class="arrow-link al-hover bs-tech"
              ><i
                ><img
                  src="img/svg/arrow-link.svg"
                  alt="line arrow icon" /></i
              >ABOUT US</a
            >
            <a href="services" class="arrow-link al-hover bs-tech"
              ><i
                ><img
                  src="img/svg/arrow-link.svg"
                  alt="line arrow icon" /></i
          ...
          <div class="grid-inner">
            ...
            <div class="bs-grid xs-wrap">
              <div class="bs-xl-7 bs-xs-22">
                <h2 class="section-title">
                  <i class="circle-tag"></i><i class="circle-tag"></i>Projects
                </h2>
                <h3 class="bs-160 upper xl-top-1 split chars">
                  Recent work<i class="dot view"></i>
                </h3>
                <article
                  class="bs-xl-7 bs-xs-22 xl-top-2 xs-top-1"
                  data-speed=".95"
                >
                      ...
                      <i class="work-lottie">
                        ...
                        >
                          ...
                          <image
                            ...
                            height="100%"
                            mask="url(#imgMask1)"
                            href="img/work/thumb-ssi-1x.webp"
                          />
                        </svg>
                      </i>
                    </figure>
                    <h2 class="thumb-title bs-14 upper FontBody">
                      Sling Shot Intergalactic
                    </h2>
                  </a>
                </article>
              </div>
              <article class="bs-xl-9 bs-xl-os-2 bs-xs-22 bs-xs-os-0 xs-top-1">
                <a href="opositivehtml">
                  <figure>
                    <i class="work-lottie">
                      <svg
                        viewBox="0 0 660 660"
                      ...
                      >
                        ...
                        <image
                          ...
                          height="100%"
                          mask="url(#imgMask2)"
                          href="img/work/thumb-op-1x.webp"
                        />
                      </svg>
                    </i>
                  </figure>
                  <h2 class="thumb-title bs-14 upper FontBody">O Positive</h2>
                </a>
              </article>
            </div>
            <div class="bs-grid xl-top-3 xs-top-1 xs-wrap">
              <article
                class="bs-xl-8 bs-xl-os-2 bs-xs-22 bs-xs-os-0"
                data-speed=".9"
              >
                    ...
                    <i class="work-lottie">
                      ...
                      >
                        ...
                        <image
                          ...
                          height="100%"
                          mask="url(#imgMask3)"
                          href="img/work/thumb-hy-1x.webp"
                        />
                      </svg>
                    </i>
                  </figure>
              ...
              <article
                class="bs-xl-6 bs-xl-os-2 bs-xs-22 bs-xs-os-0 xl-top-6 xs-top-1"
                data-speed="1.05"
              >
                    ...
                    <i class="work-lottie">
                      ...
                      >
                        ...
                        <image
                          ...
                          height="100%"
                          mask="url(#imgMask4)"
                          href="img/work/thumb-oa-1x.webp"
                        />
                      </svg>
                    </i>
                  </figure>
                  <h2 class="thumb-title bs-14 upper FontBody">Ocean Agency</h2>
                </a>
              </article>
            </div>
          </div>
        ...
        <div
          class="bs-xl-6 bs-xl-os-15 bs-xs-22 bs-xs-os-1 view xl-top-4 xl-bottom-2 xs-top-2"
        >
          <a href="work.html" class="arrow-link al-hover bs-tech"
            ><i><img src="img/svg/arrow-link.svg" alt="line arrow icon" /></i
            >View all work</a
          >
        </div>
        ...
        <section id="attitude" class="xs-top-3">
          ...
          <div class="boxes">
            <div>
              <article class="box">
                <h3 class="section-title">
                  <i class="circle-tag"></i><i class="circle-tag"></i>RULE NO.1
                </h3>
                <h4 class="bs-60 upper">DISCIPLINE</h4>
                <p>
                  At our core, we are a team of disciplined professionals who
                  are passionate about our craft. Our process is thorough,
                  ensuring that we create work that is not only buzzworthy, but
                  also surpasses your expectations.
                </p>
              </article>
            </div>
            <div class="b-end stack">
              <article class="box">
                <h3 class="section-title">
                  <i class="circle-tag"></i><i class="circle-tag"></i>RULE NO.2
                </h3>
                <h4 class="bs-60 upper">Trust</h4>
                <p>
                  Trust is essential in our client relationships. As experts in
                  our field, we always strive to make the best decisions for
                  your brand. We kindly ask you to place your trust in our
                  process and unwavering dedication to your success.
                </p>
              </article>
            </div>
            <div class="b-middle stack">
              <article class="box">
                <h3 class="section-title">
                  <i class="circle-tag"></i><i class="circle-tag"></i>RULE NO.3
                </h3>
                <h4 class="bs-60 upper">Passion</h4>
                <p>
                  Our passion for what we do is evident in what we create. We
                  pour all of our creativity and expertise into each project,
                  ensuring that the end result is a unique and valuable website
            ...
            <div class="stack">
              <article class="box">
                <h3 class="section-title">
                  <i class="circle-tag"></i><i class="circle-tag"></i>RULE NO.4
                </h3>
                <h4 class="bs-60 upper">Devotion</h4>
                <p>
                  We are devoted to our clients and to delivering our best work.
                  Our commitment to perfection means that we won't stop until
                  you are raving about us to everyone you know.
                </p>
              </article>
            </div>
            <div class="b-middle stack">
              <article class="box">
                <h3 class="section-title">
                  <i class="circle-tag"></i><i class="circle-tag"></i>RULE NO.5
                </h3>
                <h4 class="bs-60 upper">Promise</h4>
                <p>
                  We understand that redesigning your entire brand or website
                  can be a daunting change. Our promise to you is that we will
                  always strive to make you happy and satisfied with our work.
                </p>
              </article>
            </div>
          </div>
        ...
        <section id="clients">
          <header class="grid-inner bs-grid xs-top-2 xs-wrap xs-reverse">
            <div class="bs-xl-6 bs-sm-8 bs-xs-22 clients-left">
              <div>
                <h2 class="section-title">
                  <i class="circle-tag"></i><i class="circle-tag"></i>True
                  partnership
                </h2>
              </div>
              <p class="sm-top-1 split lines">
                At Buzzworthy, our goal is to exceed expectations and build
                lasting partnerships. Through open communication, trust, and
                shared aspirations, we establish relationships built on mutual
                respect, fostering collaborative journeys toward greatness.
              </p>
            </div>
            <div class="bs-xl-8 bs-xl-os-3 bs-sm-os-2 bs-xs-22 bs-xs-os-0">
              <h3 class="bs-120 upper split chars">
                Join the Buzzworthy Family<i class="dot view"></i>
              </h3>
            </div>
          </header>
            ...
            <div class="row xs-wrap">
              <div class="bs-xl-5 bs-xs-10">
                <div class="client-item" data-client="1">
                  <img
                    src="img/home/client-oa.webp"
                    alt="Ocean agency Logo"
              ...
              <div class="bs-xl-6 bs-xs-10">
                <div class="client-item bs-xl-os-1 bs-xs-os-0" data-client="2">
                  <img
                    src="img/home/client-wework.webp"
                    alt="Wework logo"
              ...
              <div class="bs-xl-6 bs-xs-10">
                <div class="client-item bs-xl-os-1 bs-xs-os-0" data-client="3">
                  <img
                    src="img/home/client-selene.svg"
              ...
              <div class="bs-xl-6 bs-xs-10">
                <div class="client-item bs-xl-os-1 bs-xs-os-0" data-client="4">
                  <img
                    src="img/home/client-hy.svg"
                    alt="Hoboken Yogi Logo"
            ...
            <div class="row xs-wrap">
              <div class="bs-xl-5 bs-xs-10">
                <div class="client-item" data-client="5">
                  <img
                    src="img/home/client-modernmd.svg"
                    alt="Modern MD Logo"
              ...
              <div class="bs-xl-6 bs-xs-10">
                <div class="client-item bs-xl-os-1 bs-xs-os-0" data-client="7">
                  <img
                    src="img/home/client-helias.svg"
              ...
              <div class="bs-xl-6 bs-xs-10">
                <div class="client-item bs-xl-os-1 bs-xs-os-0" data-client="8">
                  <img
                    src="img/home/client-awestruck.svg"
            ...
            <div class="client-stat">
              ...
              <div class="stat-inner">
                <span class="stat-icon"
                  ><img src="img/svg/heart-icon.svg" alt="Heart Icon"
                /></span>
        ...
        <section id="awards" class="grid-inner xs-top-4">
          <div class="awards-scroll">
            <span>a</span><span>w</span><span>a</span><span>r</span
            ><span>d</span><span>s</span>
            <figure class="frame bs-xl-3 bs-xl-os-3">
              <img
                class="lazy"
                src="img/home/awd-08-prel.webp"
                data-src="img/home/awd-08-1x.webp"
                data-src-mobile="img/home/awd-08-1x.webp"
                data-src-big="img/home/awd-08-2x.webp"
                alt="Valaclava 3d render figures"
              />
            </figure>
            <figure class="frame bs-xl-3 bs-xl-os-12">
              <img
                class="lazy"
                src="img/home/awd-02-prel.webp"
                data-src="img/home/awd-02-1x.webp"
                data-src-mobile="img/home/awd-02-1x.webp"
                data-src-big="img/home/awd-02-2x.webp"
                alt="Valaclava 3d render figures"
              />
            </figure>
            <figure class="frame bs-xl-3 bs-xl-os-6">
              <img
                class="lazy"
                src="img/home/awd-03-prel.webp"
                data-src="img/home/awd-03-1x.webp"
                data-src-mobile="img/home/awd-03-1x.webp"
                data-src-big="img/home/awd-03-2x.webp"
                alt="Valaclava 3d render figures"
              />
            </figure>
            <figure class="frame bs-xl-3 bs-xl-os-10">
              <img
                class="lazy"
                src="img/home/awd-04-prel.webp"
                data-src="img/home/awd-04-1x.webp"
                data-src-mobile="img/home/awd-04-1x.webp"
                data-src-big="img/home/awd-04-2x.webp"
                alt="Valaclava 3d render figures"
              />
            </figure>
            <figure class="frame bs-xl-3 bs-xl-os-3">
              <img
                class="lazy"
                src="img/home/awd-05-prel.webp"
                data-src="img/home/awd-05-1x.webp"
                data-src-mobile="img/home/awd-05-1x.webp"
                data-src-big="img/home/awd-05-2x.webp"
                alt="Valaclava 3d render figures"
              />
            </figure>
            <figure class="frame bs-xl-3 bs-xl-os-11">
              <img
                class="lazy"
                src="img/home/awd-06-prel.webp"
                data-src="img/home/awd-06-1x.webp"
                data-src-mobile="img/home/awd-06-1x.webp"
                data-src-big="img/home/awd-06-2x.webp"
                alt="Valaclava 3d render figures"
              />
            </figure>
            <figure class="frame bs-xl-3 bs-xl-os-6">
              <img
                class="lazy"
                src="img/home/awd-07-prel.webp"
                data-src="img/home/awd-07-1x.webp"
                data-src-mobile="img/home/awd-07-1x.webp"
                data-src-big="img/home/awd-07-2x.webp"
                alt="Valaclava 3d render figures"
              />
            </figure>
          </div>
          ...
          <div class="awards-content">
            ...
            <h3 class="section-title">
              <i class="circle-tag"></i><i class="circle-tag"></i>Latest award
            </h3>
            <div class="bs-grid xs-wrap grid-middle">
              <div class="bs-xl-6 bs-xs-22 xs-top-1">
                <a
                  href="work/slingshot"
                  class="circle-link view"
                  aria-label="Sling Shot"
                >
                  <h4 class="cl-inner bs-120 upper">
                    Sling Shot
                    <div class="circle-icon">
                      <i></i>
                      <span
                        ><img
                          src="img/svg/arrow-hex.svg"
        ...
        <section
          id="testimonials"
          class="xl-top-4 draggable-container xs-top-4"
        >
          <header class="grid-inner bs-grid grid-between xs-wrap">
            <div class="bs-xl-6 bs-xs-22">
              <h2 class="section-title">
                <i class="circle-tag"></i><i class="circle-tag"></i>Testimonials
              </h2>
            </div>
            <div class="bs-xl-8 bs-xs-18 right xs-left xs-top-1">
              <h3 class="bs-120 upper split chars">
                We keep our promise<i class="dot view"></i>
              </h3>
            </div>
          </header>
            ...
            <div class="slider-inner">
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>Lewis
                    Herrin, CEO / SSI
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/lewis.webp"
                      alt="Lewis Herrin"
                    /><span
                      >They are friendly, engaging and excellent at what they
                      do. Great ideas and a great interpretation of our
                      needs.</span
                    >
                  </p>
                </article>
              ...
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>JULIANNE
                    HOUGH / Kinrgy
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/hough.webp"
                      alt="Julianne Hough"
                    /><span
                      >Among the plethora of agencies we spoke with, Buzzworthy
                      stood out significantly. Their work not only exceeded our
                      expectations, but what truly set them apart was the sheer
                      talent within their team. They breathed life into our
                      vision with finesse and expertise.</span
                    >
                  </p>
                </article>
              </div>
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>RICHARD
                    VEVERS, CEO / Ocean Agency
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/richard.webp"
                      alt="Richard Vevers"
                    /><span
                      >Our site was unveiled in September 2023, and the influx
                      of requests has soared to 10x compared to our previous
                      website. Buzzworthy met our stringent deadlines, but they
                      also catapulted us beyond our expectations, designing an
                      absolute masterpiece.</span
                    >
                  </p>
                </article>
              </div>
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>ROB
                    D’AMBROSIO, FOUNDER / Helias
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/helias.webp"
                      alt="Rob D Amrosio"
                    /><span
                      >Our website has received numerous design awards and
                      garnered us traffic growth +1000% YOY. I was also very
                      impressed by and appreciative of how the team made
                      anything we asked possible.</span
                    >
                  </p>
                </article>
              </div>
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>DAVID
                    MARCY, COO / Awestruck
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/marcy.webp"
                      alt="David Marcy"
                    /><span
                      >They are friendly, engaging and excellent at what they
                      do. Great ideas and a great interpretation of our
              ...
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>TYLER
                    BARNET / Grapeseed Media
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/tyler.webp"
                      alt="Tyler Barnet"
                    /><span
                      >Their design skills were uncanny. They produced a
                      top-tier, custom work of art.</span
                    >
                  </p>
                </article>
              </div>
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>LYNDA
                    CHOU / IQ Research
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/chou.webp"
                      alt="Lynda Chou"
                    /><span
                      >Our company has grown tremendously over the past year
                      since the launch of our site and our marketing campaigns.
                      Our site traffic has quadrupled since Darren has been
                      working with us on SEO and the leads we are getting are
                      much more qualified.</span
                    >
                  </p>
                </article>
              </div>
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>Jill S.
                    / Hoboken Yogi
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/jill.webp"
                      alt="Jill S."
                    /><span
                      >My website is visually stunning and has received many
                      compliments for the design, but what truly stands out to
                      me is the marketing plan created by Darren and Andrew.
                      This plan has orchestrated remarkable growth for my
                      business, leaving me thoroughly impressed.</span
                    >
                  </p>
                </article>
              </div>
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>Saad
                    Shaikh, CEO / Snooze
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/saad.webp"
                      alt="Saad Shaikh"
                    /><span
                      >We had great feedback from our brand and our website.
                      When we launched we were indexing very strongly thanks to
                      the content we had on our page, as suggested from the
                      growth marketing lead at Buzzworthy. We were able to book
                      100’s of sleep test orders thanks to the easy flow of the
                      website.</span
                    >
                  </p>
                </article>
              ...
              <div class="slide-item view">
                <article class="testimonial bs-xl-8 bs-xl-os-1 bs-xs-20">
                  <h3 class="section-title">
                    <i class="circle-tag"></i><i class="circle-tag"></i>MELISSA
                    COHEN, CMO / ModernMD
                  </h3>
                  <p>
                    <img
                      src="img/testimonials/mellisa.webp"
                      alt="Melissa Cohen"
                    /><span
                      >Beyond their technical skill, I appreciated how they
                      presented themselves. They were professional, and we got a
                      lot of work done. However, they were also casual in an
                      approachable way, so, every time we had a call, it was
                      just a normal dialogue. It was almost like working with a
                      friend and that’s what you want in a partner.</span
                    >
                  </p>
                </article>
              </div>
                ...
                <div class="bs-grid grid-between grid-bottom xs-wrap">
                  <div class="bs-xl-4 bs-xs-14">
                    <ul class="service-links">
                      <li>
                        <a class="text-link" href="services/website-design"
                          ><span>Website design </span></a
                        >
                      </li>
                      <li>
                        <a class="text-link" href="services/motion-design"
                      ...
                      <li>
                        <a
                          ...
                          ><span>Front-end development</span></a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><span>Back-end development</span></a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><span>Shopify development</span></a
                        >
                      </li>
                      <li>
                        <a class="text-link" href="services/website-support"
                      ...
                      <li>
                        <a
                          class="text-link"
                          href="services/paid-search-advertising"
                          ><span>Paid Search Advertising</span></a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><span>Social Media Advertising</span></a
                        >
                      </li>
                      <li>
                        <a class="text-link" href="services/email-marketing"
                          ><span>Email Marketing</span></a
                        >
                      </li>
                      <li>
                        <a class="text-link" href="services/seo"
                          ><span>SEO</span></a
                        >
                      </li>
                    </ul>
            ...
            <div class="bs-grid footer-bottom grid-bottom xs-top-1 sm-wrap">
                    ...
                    <i>
                      ...
                      >
                        <path
                          vector-effect="non-scaling-stroke"
                          class="nl-line"
                          d="M0.852905 4.35493L8.81351 4.35352"
                          stroke="#EEEEF2"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
              ...
              <div class="bs-xl-13 bs-xl-os-1 bs-sm-22 bs-sm-os-0 sm-top-1">
                <div class="bs-grid grid-between xs-wrap">
                  ...
                  <div
                    class="bs-xl-8 bs-sm-14 bs-xs-22 right xs-center xs-top-1"
                  >
                    <ul class="bs-14">
                      <li>
                        <a
